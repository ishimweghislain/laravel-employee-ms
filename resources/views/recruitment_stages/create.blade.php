...
@section('title', 'Add Recruitment Stage')
...
<div class="container">
    <div class="form-card">
        <div class="card-header">
            <h2>Add New Recruitment Stage</h2>
        </div>
        ...
        <form action="{{ route('recruitment_stages.store') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" name="stage_status" class="form-input" value="{{ old('stage_status') }}" required>
            </div>

            <div class="form-group">
                <label class="form-label">Completion Date</label>
                <input type="date" name="completion_date" class="form-input" value="{{ old('completion_date') }}">
            </div>

            <div class="button-group">
                <a href="{{ route('recruitment_stages.index') }}" class="btn btn-secondary">Cancel</a>
                <button type="submit" class="btn btn-primary">Add Recruitment Stage</button>
            </div>
        </form>
    </div>
</div>
