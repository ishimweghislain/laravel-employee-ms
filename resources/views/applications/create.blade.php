    ...
    <div class="form-card">
        ...
        <form action="{{ route('applications.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="applicant_id" class="form-input" required>
                    ...
                    @foreach($applicants as $applicant)
                        <option value="{{ $applicant->ApplicantId }}">{{ $applicant->FirstName }} {{ $applicant->LastName }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="job_id" class="form-input" required>
                    ...
                    @foreach($jobPositions as $jobPosition)
                        <option value="{{ $jobPosition->JobId }}">{{ $jobPosition->Title }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="application_status" class="form-input" value="{{ old('application_status') }}" required>
            </div>
